...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/rich-click-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/rich-click-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install rich-click
```
...
It is possible to list all of the versions of `rich-click` available on your platform:
...
```
pixi search rich-click --channel conda-forge
```
